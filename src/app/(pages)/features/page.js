                ...
                <div className="container px-4 mx-auto">
                    <div className="flex -mx-4">
                        <div className="px-4 text-center md:w-10/12 xl:w-8/12 mx-auto">
                            ...
                            <button className="border-2 border-solid border-green-600 rounded py-2 px-12 text-xl text-green-600 hover:bg-green-600 hover:text-white mt-4 transition-color duration-300">
                                Learn More
                            </button>
                        </div>
                    </div>
